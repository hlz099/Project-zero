...
#ifndef FBLTSPHASE_H_
#define FBLTSPHASE_H_
...
class FBLTS_phase: public EMTG::phase {
public:
	//constructor
	FBLTS_phase();
	FBLTS_phase(int j, int p, missionoptions* options);
	...
	vector <double> event_s_values;
	vector <double> time_step_width;
	double s_final;
